...
parser.add_argument('--every_epochs', type=int, default=1000, help='maximum number of epochs to train the total model')
parser.add_argument('--batch_size', type=int, default=8, help='batch size to use per GPU')
parser.add_argument('--lr', type=float, default=4e-4, help='learning rate')
parser.add_argument('--num_workers', type=int, default=16, help='number of workers')
parser.add_argument('--fixed', type=lambda x: x.lower() in ["true", "1", "t"], default=False, help="Boolean flag for fixed")
