...
from net.adair_depth import AdaIR
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enhance_path', type=str, default="/data2t/AirNet-Data/test/lolv1/", help='save path of test hazy images')
    ...
    ckpt_path = "/home/zzy/DepthDehaze/MMAiOIR/adair5depth2l_ckpt/epoch=132-step=1112295.ckpt"
