...
#             out.append(data)
#     return out
def apply_consistent_augmentation(clean_patch, depth_map):
    # 假设 random_augmentation 函数接受两个图像并返回增强后的图像
    augmented_clean, augmented_depth = random_augmentation(clean_patch, depth_map)
    return augmented_clean, augmented_depth
